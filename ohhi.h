 ...
 *           contain three or more consecutive tiles of the specified color.bool rows_are_different(const int board[MAX_SIZE][MAX_SIZE],
 int size,
 int row1,
 int row2) {
 int counter = 0;
 
 //Check for any unknowns and return true
...
/**
 * --------------------------------------------------------
 * --------- STUDENT-IMPLEMENTED S'MORE FUNCTIONS ---------
 * --------------------------------------------------------
 * --------- You will need to implement these -------------
 * --------- ONLY IF completing the additional ------------
 * --------- S'more version of the project ----------------
 * --------------------------------------------------------
 */
